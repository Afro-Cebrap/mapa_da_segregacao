...
def _criar_modelo_municipios(ano: int):
    return type(
        f"MunicipiosModel{ano}",
        (Base,),
        {
            "__tablename__": f"municipios_{ano}",
...
MunicipiosModel2010 = _criar_modelo_municipios(2010)
MunicipiosModel2022 = _criar_modelo_municipios(2022)

MODELOS_MUNICIPIOS_POR_ANO = {2010: MunicipiosModel2010, 2022: MunicipiosModel2022}
