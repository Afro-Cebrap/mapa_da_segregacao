...
def _criar_modelo_reg_metro(ano: int):
    return type(
        f"RegiaoMetropolitanaModel{ano}",
        (Base,),
        {
            "__tablename__": f"reg_metropo_{ano}",
...
RegiaoMetropolitanaModel2010 = _criar_modelo_reg_metro(2010)
RegiaoMetropolitanaModel2022 = _criar_modelo_reg_metro(2022)
