		...
		<MotionConfig reducedMotion="user">
			<div className="relative overflow-x-clip">
			   ...
			   proposital com o título. */}
				...
				{/* Hero — anima na carga da página (já está na viewport). */}
				<Reveal
					as="section"
					className="mx-auto max-w-7xl px-6 pt-12 pb-16 md:px-16 md:pt-16 md:pb-32"
				>
				...
				<section className="relative mx-auto max-w-7xl px-6 py-16 md:px-16 md:py-20">
				   ...
				   o conteúdo das seções fica acima via z-10. */}
					...
					<Reveal className="relative z-10">
						...
						<div className="mt-7 grid grid-cols-1 gap-x-18 gap-y-10 sm:grid-cols-2 md:mt-14 md:ml-24 md:grid-cols-3 md:gap-y-12">
				...
				<section className="dark-panel relative w-full">
				   ...
				   (base ≈ topo do painel + 1222px em todas as larguras). */}
					...
					/>
					<Reveal className="relative z-10 mx-auto max-w-7xl px-6 py-16 md:px-16 md:py-24">
				...
				<Reveal
					as="section"
					className="relative mx-auto max-w-7xl px-6 py-16 md:px-16 md:py-24"
				>
